                        ...
                        <table id="user-table" class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($users as $user)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 border-b-2 border-gray-200">{{ $user->name }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 border-b-2 border-gray-200">{{ $user->email }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 border-b-2 border-gray-200">{{ $user->role }}</td>
        ...
        $(document).ready(function() {
            $('#user-table').DataTable({
                ...
                "language": {
                    ...
                    "emptyTable": "Belum ada user yang terdaftar.",
