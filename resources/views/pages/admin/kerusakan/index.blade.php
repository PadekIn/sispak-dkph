                        ...
                        <table id="kerusakan-table" class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($kerusakans as $kerusakan)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 border-b-2 border-gray-200">{{ $kerusakan->jenis_kerusakan }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 border-b-2 border-gray-200">{{ $kerusakan->solusi }}</td>
