                    ...
                    <form method="POST" action="{{ route('admin.kerusakan.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <select id="jenis_kerusakan" name="jenis_kerusakan" class="block mt-1 w-full" required>
                                ...
                                <option value="batre" {{ old('jenis_kerusakan') == 'Baterai' ? 'selected' : '' }}>Baterai</option>
                                <option value="lcd" {{ old('jenis_kerusakan') == 'LCD' ? 'selected' : '' }}>LCD</option>
                                <option value="konektor_charger" {{ old('jenis_kerusakan') == 'Konektor Charger' ? 'selected' : '' }}>Konektor Charger</option>
                                <option value="kamera" {{ old('jenis_kerusakan') == 'Kamera' ? 'selected' : '' }}>Kamera</option>
                                <option value="mesin" {{ old('jenis_kerusakan') == 'Mesin' ? 'selected' : '' }}>Mesin</option>
                            </select>
