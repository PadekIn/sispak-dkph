            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-2">
                        <h3 class="text-lg font-medium text-gray-900 mb-2 sm:mb-0">Daftar Gejala</h3>
                    ...
                    <div class="overflow-x-auto">
                        <table id="gejala-table" class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($gejalas as $gejala)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 border-b-2 border-gray-200">{{ $gejala->kode_gejala }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 border-b-2 border-gray-200">{{ $gejala->nama_gejala }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium border-b-2 border-gray-200">
                                            <div class="flex justify gap-3">
                                                <a href="{{ route('admin.gejala.edit', $gejala->id) }}" class="text-indigo-600 hover:text-indigo-900">Ubah</a>
                                                <button type="button"
        ...
        $(document).ready(function() {
            $('#gejala-table').DataTable({
                ...
                "language": {
                    ...
                    "emptyTable": "Belum ada data gejala.",
