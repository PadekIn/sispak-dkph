<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('assets/img/logo-sispak-dkph.png') }}" alt="SISPAK-DKPH Logo" class="block h-9 w-auto">
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('pengguna.diagnosa')" :active="request()->routeIs('pengguna.diagnosa')">
                {{ __('Diagnosa') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('pengguna.histori')" :active="request()->routeIs('pengguna.histori')">
                {{ __('Histori') }}
            </x-responsive-nav-link>
        </div>
