...
class KerusakanSeeder extends Seeder
{
    ...
    {
        Kerusakan::create(['nama_kerusakan' => 'Kerusakan LCD', 'jenis_kerusakan' => 'LCD', 'solusi' => 'Ganti baterai baru']);
        Kerusakan::create(['nama_kerusakan' => 'Kerusakan Baterai', 'jenis_kerusakan' => 'Baterai', 'solusi' => 'Ganti LCD baru']);
