...
class GejalaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Gejala::create(['kode_gejala' => 'G02', 'nama_gejala' => 'Main harus sambil dicharger, jika tidak dicharger mati']);
        Gejala::create(['kode_gejala' => 'G02', 'nama_gejala' => 'Baterai cepat habis']);
        Gejala::create(['kode_gejala' => 'G03', 'nama_gejala' => 'HP tidak bisa dicharger']);
