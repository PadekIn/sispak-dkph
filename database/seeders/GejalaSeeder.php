...
class GejalaSeeder extends Seeder
{
    ...
    {
        Gejala::create(['kode_gejala' => 'G01', 'nama_gejala' => 'Layar menampilkan garis-garis (horizontal atau vertikal) yang mengganggu tampilan']);
        Gejala::create(['kode_gejala' => 'G02', 'nama_gejala' => 'Layar hanya menampilkan warna hitam tanpa gambar sama sekali (blank hitam)']);
        Gejala::create(['kode_gejala' => 'G03', 'nama_gejala' => 'HP menyala (ada suara atau getaran), tetapi layar tetap mati atau tidak menampilkan gambar']);
        ...
        Gejala::create(['kode_gejala' => 'G07', 'nama_gejala' => 'Bagian layar atau bodi HP terlihat menggembung atau tidak rata']);
        ...
        Gejala::create(['kode_gejala' => 'G18', 'nama_gejala' => 'Hasil foto kamera buram atau tidak jelas meskipun lensa bersih']);
        ...
        Gejala::create(['kode_gejala' => 'G22', 'nama_gejala' => 'HP pernah atau baru saja terkena atau kemasukan air']);
